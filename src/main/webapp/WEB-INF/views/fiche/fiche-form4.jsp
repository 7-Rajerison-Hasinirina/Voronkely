...
<div class="container py-5">
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form action="/fiche4" method="post" data-repeatable>
                ...
                <div data-repeatable-rows>
                    <div class="row g-3 align-items-end mb-3" data-repeatable-row>
                        <div class="col-md-2">
                            ...
                            <input type="number" class="form-control" name="taona">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Sekoly</label>
                            <input type="text" class="form-control" name="sekoly" maxlength="50">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <textarea class="form-control" name="taranjaManavanana"></textarea>
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Taranja manahirana</label>
                            <textarea class="form-control" name="taranjaManahirana"></textarea>
                        </div>
                        <div class="col-12">
