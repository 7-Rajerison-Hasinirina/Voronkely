...
<form method="post"
action="${pageContext.request.contextPath}/mouvement-adidy">
...
<script src="${pageContext.request.contextPath}/javascript/adidy.js"></script>
